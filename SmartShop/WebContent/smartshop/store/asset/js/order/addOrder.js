...
function setCartData() {
    document.getElementById("shop").innerHTML = "时尚店铺2";
    document.getElementById("name").innerHTML = "<font color='#CC0000'>高等数学</font>";
    document.getElementById("price").innerHTML = 10.2;
    document.getElementById("type").innerHTML= "31码";
    document.getElementById("attribute").innerHTML = "红色";
