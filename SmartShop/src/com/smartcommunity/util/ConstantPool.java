...
public class ConstantPool {
	...
	public static final String PATH_TYPEFACE_CSS = "./SmartProperty/bootstrap/css/typeface.css";
	

	public static final String SESSION_USER_ID =  "id";
	public static final String SESSION_NAME =  "name";
	public static final String SESSION_PASSWORD =  "name";
	public static final String SESSION_TELEPHONE =  "telephone";
